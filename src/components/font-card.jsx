...
export default function FontCard({ FontName, TotalStyles, FontFamily, FontPath }) {
  return (
    <a
  href={newPath} id={FontPath}
  class="relative flex flex-col items-stretch duration-300 ease-out p-7 sm:p-7 group h-100 rounded-2xl" aria-label={`${FontName} font`}
>
  <span
  ...
  >
        ...
        <span style={`font-family: ${FontFamily}!important;`} class={isSmall ? "text-[1.8rem] leading-[2rem] visible-animation" : "text-[1.5rem] leading-[2rem]"}>আমার সোনার বাংলা<br/>আমি তোমায় ভালোবাসি</span>
    
    
      <div
        class="w-full mt-5 mb-1 sm:mt-3 flex items-center mb-0 text-base font-semibold tracking-tight text-neutral-900 dark:text-neutral-100"
      >
        <h2>{FontName}</h2>
        <svg
      ...
      <p class="text-sm text-neutral-600 dark:text-neutral-400 block truncate"
        >{TotalStyles} styles</p>
